--[[
    hitboxExtender.lua (FIXED - Uses Game's Own Detection)
    
    Creates proxy hitboxes around enemies.
    When your blade touches proxy, it teleports enemy to blade
    so game's own blade:GetTouchingParts() detects the hit.
--]]
...
function hitboxExtender:On()
    local function createHitbox(player)
        ...
        -- Use new method: triggers game's own hit detection
        proxy:BindTouchWithBlade(humanoid)
